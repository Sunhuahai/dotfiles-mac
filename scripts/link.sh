...
link_file "$ROOT/cli/pi/.pi/agent/settings.json" "$HOME/.pi/agent/settings.json"
link_file "$ROOT/cli/pi/.pi/agent/agents" "$HOME/.pi/agent/agents"
link_file "$ROOT/cli/pi/.pi/agent/prompts" "$HOME/.pi/agent/prompts"
link_file "$ROOT/cli/pi/.pi/agent/novel" "$HOME/.pi/agent/novel"
link_file "$ROOT/cli/pi/.pi/agent/workbench" "$HOME/.pi/agent/workbench"
link_file "$ROOT/cli/pi/.pi/agent/extensions/input-frame.ts" "$HOME/.pi/agent/extensions/input-frame.ts"
link_file "$ROOT/cli/pi/.pi/agent/extensions/novel-team.ts" "$HOME/.pi/agent/extensions/novel-team.ts"
link_file "$ROOT/cli/pi/.pi/agent/extensions/pi-header.ts" "$HOME/.pi/agent/extensions/pi-header.ts"
link_file "$ROOT/cli/pi/.pi/agent/extensions/workbench-team.ts" "$HOME/.pi/agent/extensions/workbench-team.ts"
